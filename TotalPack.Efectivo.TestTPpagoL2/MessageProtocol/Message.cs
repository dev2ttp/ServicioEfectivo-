...
namespace TotalPack.Efectivo.TestTPpagoL2.MessageProtocol
{
    class Message
    {
        ...
        public static Message Parse(string s)
        {
            ...
            message.Data = s.Substring(StructureLength.DAT_POS, messageLength - StructureLength.FIX_LEN).Split('|').ToList();
        ...
        /// <summary>
        /// Creates a new error message with a given error code.
        /// </summary>
